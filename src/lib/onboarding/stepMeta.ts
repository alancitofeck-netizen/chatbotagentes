...
export const STEP_META: Record<OnboardingStepKey, StepMeta> = {
  ...
  manychat: { label: "Instagram / ManyChat", description: "Recibí y analizá los leads que ManyChat gestiona en tu Instagram.", ctaLabel: "Conectar ManyChat", href: "/manychat" },
...
/** Solo estos 2 pasos del checklist tienen un Product Tour real cuya
 ...
 * del checklist. "manychat" queda afuera por el mismo motivo, desde que el
 * módulo pasó a ser un dashboard verbatim servido en iframe (sin
 * data-tour ni tabs reales que un Product Tour pueda apuntar). */

 ...
 * design doc's "at most one per view" rule for that variant. Vuelve a
 * saludar por nombre acá arriba (a pedido explícito) — DashboardHomeSection
 * quedó reordenado más abajo, así que ya no queda un saludo pegado al otro. */

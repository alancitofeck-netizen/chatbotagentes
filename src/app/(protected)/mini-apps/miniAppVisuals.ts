import { PieChart, Calculator, Link2, TrendingUp, ShieldCheck, Layout, Presentation, FileText, Sparkles, Landmark, Wallet, type LucideIcon } from "lucide-react";
...
const TEMPLATE_VISUAL: Record<MiniAppTemplateKey, { icon: LucideIcon; hue: Hue }> = {
  ...
  calculadora_capacidad_ingresos: { icon: Wallet, hue: "emerald" },
};

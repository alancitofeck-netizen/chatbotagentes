...
--
-- CONFIRMAR antes de aplicar: el workspace_id de abajo corresponde al
-- workspace de Adriel Pucheta (workspaces.name = "Workspace de adripuc0189"),
-- inferido a partir de la sesión de WhatsApp Web ya confirmada ahí
-- (device_name: "Adriel Pucheta"). Ajustar si corresponde a otro workspace.
